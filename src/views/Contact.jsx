                ...
                <div className="row">
                    <div className="col-6">
                        <form className="form">
                            ...
                            <input className="form__control form-control" type="text" id="name" name="name_user"
                            ...
                            <button className="form__button btn btn-primary" type="submit">Enviar mensaje</button>
                        </form>
                    </div>
                    <div className="col-6">
